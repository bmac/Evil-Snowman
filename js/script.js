...
function setLink1(){
    var href = bmac.tophundred[bmac.currentPos];
    bmac.currentPos = bmac.currentPos + 1;
    $("#link1Animation").children().first().attr("href", href);
    console.log(    $("#link1Animation").children().first().attr("href"));   
}

function setLink2(){
    var href = bmac.tophundred[bmac.currentPos];
    bmac.currentPos = bmac.currentPos + 1;
    var link = $("#link2Animation");
    if (link === []){
	link = createNewLink("#link2Animation");
    }

    $("#link2Animation").children().first().attr("href", href);
    console.log(    $("#link2Animation").children().first().attr("href"));   
}


setInterval(setLink1, 5000);
setInterval(setLink2, 7000);
